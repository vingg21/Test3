/* src/config/retrex-config.h.  Generated from retrex-config.h.in by configure.  */
/* src/config/retrex-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef REEX_CONFIG_H

#define REEX_CONFIG_H
...
#define PACKAGE_BUGREPORT "retrex.tech"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Retrex Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Retrex Core 2.0.2"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "retrex"

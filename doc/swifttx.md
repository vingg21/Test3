...
This mechanism has been integrated into Bitcore-Node-Retrex which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Retrex-Project/insight-api-retrex#web-socket-api](https://github.com/Retrex-Project/insight-api-retrex#web-socket-api) 
* API: [https://github.com/Retrex-Project/insight-api-retrex#swifttx-transactions](https://github.com/Retrex-Project/insight-api-retrex#swifttx-transactions) 

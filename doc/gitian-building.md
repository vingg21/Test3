...
*Setup instructions for a gitian build of Retrex using a Debian VM or physical system.*
...
- [Building Retrex](#building-retrex)
...
Clone the git repositories for retrex and gitian and then checkout the retrex version that you want to build.

```bash
git clone https://github.com/devrandom/gitian-builder.git
git clone https://github.com/retrex-crypto/retrex.git
cd retrex
...
Follow the instructions in [doc/release-process.md](release-process.md) in the retrex repository
...
To build Retrex (for Linux, OSX and Windows) just follow the steps under 'perform
gitian builds' in [doc/release-process.md](release-process.md) in the retrex repository.
...
```bash
    Initialized empty Git repository in /home/debian/gitian-builder/inputs/retrex/.git/
    remote: Reusing existing pack: 35606, done.
    remote: Total 35606 (delta 0), reused 0 (delta 0)
    Receiving objects: 100% (35606/35606), 26.52 MiB | 4.28 MiB/s, done.
    Resolving deltas: 100% (25724/25724), done.
    From https://github.com/retrex-crypto/retrex
...
For example:
```bash
URL=https://github.com/crowning-/retrex.git
...
```bash
    gpg --detach-sign ${VERSION}-linux/${SIGNER}/retrex-build.assert
    gpg --detach-sign ${VERSION}-win/${SIGNER}/retrex-build.assert
    gpg --detach-sign ${VERSION}-osx/${SIGNER}/retrex-build.assert
```
...
[retrex/gitian.sigs](https://github.com/retrex-crypto/gitian.sigs/) repository, or if that's not possible to create a pull
request.
